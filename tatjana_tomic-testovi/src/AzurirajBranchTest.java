...
/*
 * Testira se prikazan branch na formi za azuriranje studenta
 */

public class AzurirajBranchTest {
  ...
  public void azurirajBranch() {
    ...
    {
      String value = driver.findElement(By.xpath("//*[@id=\"myModal\"]/div/div/form/div[2]/div[1]/div[3]/select")).getAttribute("value");
      assertThat(value, is("BCA"));
    }
  }
}
