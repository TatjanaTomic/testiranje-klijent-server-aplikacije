...
/*
 * Testira se prikazano ime na formi za azuriranje studenta
 */

public class AzurirajImeTest {
  ...
  public void azurirajIme() {
    ...
    {
      String value = driver.findElement(By.xpath("//*[@id=\"myModal\"]/div/div/form/div[2]/div[1]/div[1]/input")).getAttribute("value");
      assertThat(value, is("Tatjana"));
    }
  }
}
