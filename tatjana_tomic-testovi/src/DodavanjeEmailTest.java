...
/*
 * Testira se prikazani email novog dodanog studenta u pregledu svih studenata
 */

public class DodavanjeEmailTest {
  ...
  public void dodavanjeEmail() {
    ...
    assertThat(driver.findElement(By.xpath("/html/body/app-root/div/app-student-list/div[1]/div[2]/div/table/tbody/tr/td[2]")).getText(), is("tanja@mail.com"));
  }
}
