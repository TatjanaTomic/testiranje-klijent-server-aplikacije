...
/*
 * Testira se prikazan email na formi za azuriranje studenta
 */

public class AzurirajEmailTest {
  ...
  public void azurirajEmail() {
    ...
    {
      String value = driver.findElement(By.xpath("//*[@id=\"myModal\"]/div/div/form/div[2]/div[1]/div[2]/input")).getAttribute("value");
      assertThat(value, is("tanja@mail.com"));
    }
  }
}
