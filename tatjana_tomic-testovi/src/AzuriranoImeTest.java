...
/*
 * Testira se prikazano ime azuriranog studenta u pregledu svih studenata
 */

public class AzuriranoImeTest {
  ...
  public void azuriranoIme() {
    ...
    assertThat(driver.findElement(By.xpath("//*[@id=\"DataTables_Table_1\"]/tbody/tr/td[1]")).getText(), is("TatjanaT"));
  }
}
