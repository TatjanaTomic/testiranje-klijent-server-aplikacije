...
/*
 * Testira se prikazani branch novog dodanog studenta u pregledu svih studenata
 */

public class DodavanjeBranchTest {
  ...
  public void dodavanjeBranch() {
    ...
    assertThat(driver.findElement(By.xpath("/html/body/app-root/div/app-student-list/div[1]/div[2]/div/table/tbody/tr/td[3]")).getText(), is("BCA"));
  }
}
